namespace NZ.General.WinForms.Misc
{
    partial class FormExit
    {
        ...
        private void InitializeComponent()
        {
			...
			this.NsBackupInfo = new Janus.Windows.EditControls.UIGroupBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.NsBackupInfo)).BeginInit();
			this.NsBackupInfo.SuspendLayout();
			this.SuspendLayout();
			// 
			// NzDataAddress
			// 
			...
			// NsBackupInfo
			// 
			this.NsBackupInfo.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.NsBackupInfo.BackColor = System.Drawing.Color.Transparent;
			this.NsBackupInfo.BorderColor = System.Drawing.Color.LightSteelBlue;
			this.NsBackupInfo.Controls.Add(this.NzBackRadio);
			this.NsBackupInfo.Controls.Add(this.NzDataAddress);
			this.NsBackupInfo.Location = new System.Drawing.Point(8, 6);
			this.NsBackupInfo.Name = "NsBackupInfo";
			this.NsBackupInfo.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.NsBackupInfo.Size = new System.Drawing.Size(539, 99);
			this.NsBackupInfo.TabIndex = 69;
			// 
			// NzBackRadio
			// 
			...
			this.Controls.Add(this.NsBackupInfo);
			...
			((System.ComponentModel.ISupportInitialize)(this.NsBackupInfo)).EndInit();
			this.NsBackupInfo.ResumeLayout(false);
			this.NsBackupInfo.PerformLayout();
        ...
        private Janus.Windows.EditControls.UIGroupBox NsBackupInfo;
