...
{
    public class BindingNoteList: IBindingList
    {
        #region Logging
        ...
        private             List<DailyNote>             _ListNotes;
        private             DateTime                    _Date;
        #endregion
        #region Constructor
        public BindingNoteList(List<DailyNote> List,DateTime Date)
        {
            _ListNotes = List;
            _Date = Date;
        }
        ...
        public object this[int index]
        {
            ...
            set => _ListNotes.ToList()[index] = (DailyNote)value;
        }
