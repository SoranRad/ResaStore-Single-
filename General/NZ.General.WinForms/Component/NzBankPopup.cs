...
{
    public partial class NzBankPopup : ToolStripDropDown
    {
        #region Fields
        ...
        private ToolStripButton         NzAdd, NzRefresh, NzSelect;
        private int                     NzWidth         = 250;
        private int                     NzHeight        = 150;
        //====
        private DbConnection            _Connection;
        private Bank                    _SelectObject;
        private Manager                 _Manager;
        private List<Bank>              _List           = new List<Bank>();
        //====
        public event EventHandler       NzSelectObject,
                                        NzEscapedPress;
        #endregion
        #region Property
        public Bank     NzSelected
        {
            get => _SelectObject;
        ...
        {
            _List = _Manager.GetList<Bank>()?.ToList();
            RefreshGrid();
        }
        ...
        private void NzSelectOnClick        (object sender, EventArgs eventArgs)
        {
            if(NzGrid.CurrentRow==null)
                return;
            _SelectObject   = NzGrid.CurrentRow.DataRow as Bank;
        ...
        public  void RefreshControl         (Size PopupSize, DbConnection Connection)
        {
