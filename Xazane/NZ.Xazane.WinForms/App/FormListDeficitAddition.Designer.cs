namespace NZ.Xazane.WinForms.App
{
    partial class FormListDeficitAddition
    {
        ...
        private void InitializeComponent()
        {
			...
			this.NzDeficitAdditionKind.Size = new System.Drawing.Size(185, 31);
			...
			this.NzTabDeficit.Size = new System.Drawing.Size(185, 0);
			this.NzTabDeficit.TabStop = true;
			this.NzTabDeficit.Text = "بدهکاری";
			// 
			// NzTabAddition
			// 
			...
			this.NzTabAddition.Text = "بستانکاری";
			// 
			// NzGrid
			// 
			...
			this.Text = "لیست بدهکاری و بستانکاری ها";
