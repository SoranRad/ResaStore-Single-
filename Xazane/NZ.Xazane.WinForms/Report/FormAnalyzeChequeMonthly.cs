...
{
    public partial class FormAnalyzeChequeMonthly : Form
    {
        #region Logging
        ...
        public FormAnalyzeChequeMonthly()
        {
            InitializeComponent();
        ...
        private void RefreshGrid()
        {
            try
            {
                ...
                var list = mgr.GetReport<AnalyzeChequeMonthly>(
                    new
                    {
        ...
        {
            if (NzGrid.CurrentRow.DataRow is AnalyzeChequeMonthly row)
            {
