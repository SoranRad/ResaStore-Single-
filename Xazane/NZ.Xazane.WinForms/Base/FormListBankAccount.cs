...
{
    public partial class FormListBankAccount : Form
    {
        #region Logging
        ...
        private FormBankAccount _formBankAccount;
        private Manager         _Manager;
        #endregion
        #region Constructor
        public  FormListBankAccount  ()
        {
            InitializeComponent();
        ...
        private void RefreshGrid        ()
        {
            ...
            {
                var r = _Manager
                    .GetList<Accounts>(new {Kind=Enums.NzAccountKind.BankAccount})?
                    .ToList();

                mS_GridX1.DataSource = r;
            }
            catch (Exception ex)
            {
        ...
        private void Create_Form        (Accounts Account)
        {
            _formBankAccount?.Dispose();

            _formBankAccount                = new FormBankAccount(_Manager ,Account);
            _formBankAccount.MS_Do_Save     += Frm_MS_Do_Save;
            _formBankAccount.FormClosed     += Frm_FormClosed;
        }
        ...
        {
            Create_Form(null);
            _formBankAccount.Show(this);
        }
        private void FormListBankAccount_Load       (object sender, EventArgs e)
        {
            RefreshGrid();
        }
