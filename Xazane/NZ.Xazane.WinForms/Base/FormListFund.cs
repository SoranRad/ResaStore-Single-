...
{
    public partial class FormListDeficit : Form
    {
        #region Logging
        ...
        private   FormFund   _FormDeficit;
        private   Manager       _Manager;
        #endregion
        #region Constructor
        public FormListDeficit()
        {
            InitializeComponent();
        ...
        private void    RefreshGrid            ()
        {
            try
            {
                mS_GridX1.DataSource = _Manager
                    .GetList<Accounts>(new { Kind = Enums.NzAccountKind.Fund })?
                    .ToList();
            }
            catch (Exception ex)
            {
        ...
        private void    Create_Form            (Accounts Deficit)
        {
            _FormDeficit?.Dispose();

            _FormDeficit            = new FormFund(_Manager,Deficit);
            _FormDeficit.MS_Do_Save += Frm_MS_Do_Save;
            _FormDeficit.FormClosed += Frm_FormClosed;
        }
