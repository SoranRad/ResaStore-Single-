...
{
    public partial class FormArrive_Back : Form_Mother_IRANSans
    {
        #region Logging
        ...
        private Enums.NzChequeStateFlag _Kind;
        #endregion
        #region Constructor
        public FormArrive_Back      (Enums.NzChequeStateFlag Kind, List<ChequeList> List)
        {
            InitializeComponent();
            _ListCheque     = List;
        ...
        private void    SetLayout  ()
        {
            ...
            if(panel1.Visible)
                this.Height     = 330;
            var str = _Kind == Enums.NzChequeStateFlag.Vosul
                ? "وصول"
                : "برگشت";
            label5.Text         = @"تاریخ " + str + @" چـکـهـا";
            NzDateArrive.Text   = @" "       + str + NzDateArrive.Text;
            NzDateUsanc.Text    = @" "       + str + NzDateUsanc.Text;
        }
        private bool    IsOK       ()
        {
        ...
        {
            SetLayout();
            this.Text = _Kind == Enums.NzChequeStateFlag.Vosul
                ? "وصول چـک پرداختی"
                : "برگشت دادن چـک";
        ...
        private void    FormArrive_Back_Shown      (object sender, EventArgs e)
        {
            Init();
        }
        private void    FormArrive_Back_KeyUp      (object sender, KeyEventArgs e)
        {
        ...
        private void    ms_Save_Click              (object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _Manager.GetReport<PaymentChequeArriveBackInDate>(new
                    {
                        Kind = (byte)_Kind,
                        Date,
                ...
                {
                    _Manager.GetReport<PaymentChequeArriveBack>(new
                    {
                        Kind = (byte)_Kind,
                        Date,
                        User = SystemConstant.ActiveUser.ID,
