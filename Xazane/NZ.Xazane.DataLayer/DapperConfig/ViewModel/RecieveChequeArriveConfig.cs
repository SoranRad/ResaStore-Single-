...
{
    public class RecieveChequeArriveConfig :DapperEntityConfiguration<RecieveChequeArrive>
    {
        public RecieveChequeArriveConfig()
        {
            this.SetList(@"
                    ...
                    SET Kind_Vaziat			= @Kind,
                        ...
                        FK_Xazaneh_Vaziat	= @Account,
	                    FK_Salmali_Vaziat	= @Year,
	                    Tarix_Vaziat		= COALESCE(tarikh_sar_resid ,@Date,GETDATE()),
