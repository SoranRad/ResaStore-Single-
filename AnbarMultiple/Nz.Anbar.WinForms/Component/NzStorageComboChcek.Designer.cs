...
{
	partial class NzStorageComboChcek
	{
		/// <summary>
		...
		{
			this.NzList = new Nz.Anbar.WinForms.Component.NzStorageCheckBox();
			this.SuspendLayout();
			// 
			// NzList
			// 
			...
			this.NzList.Size = new System.Drawing.Size(365, 187);
		...
		private NzStorageCheckBox NzList;
	}
}
