namespace Nz.Anbar.WinForms.Component
{
	partial class NzStorage
	{
		...
		{
			this.NzList = new Nz.Anbar.WinForms.Component.NzListStorage();
			this.SuspendLayout();
			// 
			// NzList
			// 
			...
			this.NzList.Size = new System.Drawing.Size(347, 201);
