namespace Nz.Anbar.WinForms.Component
{
	partial class NzPishFrosh
	{
		...
		{
			this.NzList = new Nz.Anbar.WinForms.Component.NzListPishFrosh();
			this.SuspendLayout();
			// 
			// NzList
			// 
			...
			this.NzList.Size = new System.Drawing.Size(570, 262);
		...
		private NzListPishFrosh NzList;
	}
}
