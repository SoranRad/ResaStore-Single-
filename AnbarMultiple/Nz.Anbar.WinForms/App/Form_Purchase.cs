...
namespace Nz.Anbar.WinForms.App
{
    public partial class Form_Purchase : Form_Mother_IRANSans,IForm_Editor
    {
        ...
        private void Init                           ()
        {
            ...
            NzNoRemainEffect.Visible = label19.Visible = _Kind == Enums.NzFactorKind.Frosh;
            ...
            nzObjectPopup1.RefreshControl   (new Size(650, 250));
            ...
            {
                LoadItem();
                if(_Factor.FactorItems.Count>7)
            ...
            if (_Kind == Enums.NzFactorKind.Frosh)
            {
                ...
                //if (SystemConstant.OurAccount || _Factor.FK_Mabna != null)
                //{
                //    NzMabna.Visible =
                //        NzMabnaLabel.Visible = true;
                //    NzMabna.Refresh_Grid((object)Enums.NzFactorKind.Xarid);
                //}
            }
