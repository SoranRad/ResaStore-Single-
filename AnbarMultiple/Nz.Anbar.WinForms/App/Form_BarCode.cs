...
namespace Nz.Anbar.WinForms.App
{
    public partial class Form_BarCode : Form
    {
        ...
        private void LoadSettings                   ()
        {
            Task.Run(() =>
            {
                ...
                if (Setting != null)
                {
                    ...
                    if(NzAnbar.InvokeRequired)
	                    NzAnbar.Invoke(new MethodInvoker(delegate
	                    {
		                    NzAnbar.MS_Set_Select(Setting.AnbarId);
	                    }));
                    else
	                    NzAnbar.MS_Set_Select(Setting.AnbarId);
                }
        ...
        private void NzDirecrPrint                  ()
        {
            ...
            prnFile += "\\Print\\AnbarMulti\\Pos_Print.mrt";
