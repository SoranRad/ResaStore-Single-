...
{
    public class BindingBasteBandi : IBindingList
    {
        #region Logging
        ...
        private List<BasteBandi> _ListNotes;
        public string Title { get; set; }
        #endregion
        #region Constractor
        public BindingBasteBandi(List<BasteBandi> List)
        {
            _ListNotes = List;
        ...
        public object this[int index]
        {
            ...
            set => _ListNotes.ToList()[index] = (BasteBandi)value;
        }
