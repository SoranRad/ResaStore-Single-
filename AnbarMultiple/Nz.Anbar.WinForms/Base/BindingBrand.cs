...
{
    public class BindingBrand : IBindingList
    {
        #region Logging
        ...
        private List<Brand>                     _ListNotes;
        public string   Title { get; set; }
        #endregion
        #region Constractor
        public BindingBrand(List<Brand> List)
        {
            _ListNotes = List;
        ...
        public object this[int index]
        {
            ...
            set => _ListNotes.ToList()[index] = (Brand)value;
        }
