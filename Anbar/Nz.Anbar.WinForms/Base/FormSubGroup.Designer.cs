...
namespace Nz.Anbar.WinForms.Base
{
    partial class FormSubGroup
    {
        ...
        private void InitializeComponent()
        {
			...
			this.NzShowInBarcode = new MS_Control.Controls.MS_CheckBox();
    ...
    " کاربر به برنامه از وی رمز عبور جدید درخواست می شود.";
			...
			// NzShowInBarcode
			// 
			this.NzShowInBarcode.Anchor = System.Windows.Forms.AnchorStyles.Top;
			this.NzShowInBarcode.BackColor = System.Drawing.Color.Transparent;
			this.NzShowInBarcode.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NzShowInBarcode.Location = new System.Drawing.Point(21, 149);
			this.NzShowInBarcode.Margin = new System.Windows.Forms.Padding(7, 21, 7, 21);
			this.NzShowInBarcode.MS_BorderColor = System.Drawing.Color.Transparent;
			this.NzShowInBarcode.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzShowInBarcode.MS_Change_Border_Color_On_Enter = false;
			this.NzShowInBarcode.MS_Change_Color_On_Checked = false;
			this.NzShowInBarcode.MS_Change_Color_On_Enter = false;
			this.NzShowInBarcode.MS_Checked_Color = System.Drawing.Color.FromArgb(((int)(((byte)(128)))), ((int)(((byte)(255)))), ((int)(((byte)(128)))));
			this.NzShowInBarcode.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzShowInBarcode.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzShowInBarcode.MS_Exit_By_Down = true;
			this.NzShowInBarcode.MS_Exit_By_Enter = true;
			this.NzShowInBarcode.MS_Exit_By_Up = true;
			this.NzShowInBarcode.MS_Last_Control = null;
			this.NzShowInBarcode.MS_Next_Control = null;
			this.NzShowInBarcode.MS_UnChecked_Color = System.Drawing.Color.Transparent;
			this.NzShowInBarcode.Name = "NzShowInBarcode";
			this.NzShowInBarcode.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.NzShowInBarcode.ShowFocusRectangle = false;
			this.NzShowInBarcode.Size = new System.Drawing.Size(284, 31);
			this.NzShowInBarcode.TabIndex = 819;
			this.NzShowInBarcode.Text = "در فرم فروش بارکد خوان نمایش داده شود";
			this.NzShowInBarcode.VisualStyle = Janus.Windows.UI.VisualStyle.Office2007;
			// 
			// FormSubGroup
			// 
			...
			this.Controls.Add(this.NzShowInBarcode);
		...
		private MS_Control.Controls.MS_CheckBox NzShowInBarcode;
	}
}