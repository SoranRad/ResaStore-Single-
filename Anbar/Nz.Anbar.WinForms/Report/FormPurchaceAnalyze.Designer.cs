...
{
    partial class FormPurchaceAnalyze
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.Tab_Control_Main.Size = new System.Drawing.Size(1390, 804);
			...
			this.uiTabPage12.Size = new System.Drawing.Size(1356, 802);
			...
			this.NzGridHeads.Location = new System.Drawing.Point(0, 39);
			...
			this.NzGridItems.AllowRemoveColumns = Janus.Windows.GridEX.InheritableBoolean.True;
			...
			this.NzGridItems.BuiltInTextsData = resources.GetString("NzGridItems.BuiltInTextsData");
			...
			NzGridItems_DesignTimeLayout_Reference_0.Instance = ((object)(resources.GetObject("NzGridItems_DesignTimeLayout_Reference_0.Instance")));
			NzGridItems_DesignTimeLayout_Reference_1.Instance = ((object)(resources.GetObject("NzGridItems_DesignTimeLayout_Reference_1.Instance")));
			NzGridItems_DesignTimeLayout_Reference_2.Instance = ((object)(resources.GetObject("NzGridItems_DesignTimeLayout_Reference_2.Instance")));
			NzGridItems_DesignTimeLayout_Reference_3.Instance = ((object)(resources.GetObject("NzGridItems_DesignTimeLayout_Reference_3.Instance")));
			NzGridItems_DesignTimeLayout.LayoutReferences.AddRange(new Janus.Windows.Common.Layouts.JanusLayoutReference[] {
            NzGridItems_DesignTimeLayout_Reference_0,
            NzGridItems_DesignTimeLayout_Reference_1,
            NzGridItems_DesignTimeLayout_Reference_2,
            NzGridItems_DesignTimeLayout_Reference_3});
			NzGridItems_DesignTimeLayout.LayoutString = resources.GetString("NzGridItems_DesignTimeLayout.LayoutString");
			this.NzGridItems.DesignTimeLayout = NzGridItems_DesignTimeLayout;
			this.NzGridItems.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.NzGridItems.DynamicFiltering = true;
			this.NzGridItems.EnterKeyBehavior = Janus.Windows.GridEX.EnterKeyBehavior.None;
			this.NzGridItems.FilterMode = Janus.Windows.GridEX.FilterMode.Automatic;
			...
			this.NzGridItems.ColumnButtonClick += new Janus.Windows.GridEX.ColumnActionEventHandler(this.ms_Grid_ColumnButtonClick);
			// 
			// mS_Panel2
			// 
			this.mS_Panel2.Controls.Add(this.ms_mah);
			this.mS_Panel2.Dock = System.Windows.Forms.DockStyle.Top;
			this.mS_Panel2.Location = new System.Drawing.Point(0, 0);
			...
			this.mS_Panel2.Size = new System.Drawing.Size(1356, 39);
			this.mS_Panel2.TabIndex = 723;
			// 
			// ms_mah
			// 
			...
			this.ms_mah.Location = new System.Drawing.Point(276, 11);
			...
			this.ClientSize = new System.Drawing.Size(1390, 804);
			this.Controls.Add(this.Tab_Control_Main);
			this.Name = "FormPurchaceAnalyze";
			this.Text = "گزارش مانده اقلام وارده";
