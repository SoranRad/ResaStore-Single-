...
{
	public class KharidAmaniFactors
	{
		...
		public decimal		SumPardakhti			=> (Cheque ?? 0) + (Cache ?? 0) + (Pos ?? 0) + (Takhfif ?? 0);
		public decimal		Remaind					=> (MablaqFrosh ??0) - (Cheque ?? 0) - (Cache ?? 0) - (Pos ?? 0) - (Takhfif ?? 0);
