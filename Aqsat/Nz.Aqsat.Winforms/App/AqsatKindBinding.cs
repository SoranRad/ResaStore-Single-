...
{
	public class AqsatKindBinding : IBindingList
	{
		 #region Logging
        ...
        private List<Aqsat_Kind>          _ListNotes;
        public string Title         { get; set; }
        #endregion
        #region Constractor
         public AqsatKindBinding(List<Aqsat_Kind> List)
        {
            _ListNotes = List;
        ...
        public object this[int index]
        {
            ...
            set => _ListNotes.ToList()[index] = (Aqsat_Kind)value;
        }
