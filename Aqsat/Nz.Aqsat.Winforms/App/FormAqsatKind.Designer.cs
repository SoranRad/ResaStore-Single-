namespace Nz.Aqsat.Winforms.App
{
	partial class FormAqsatKind
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormAqsatKind));
			...
			this.NzGrid.Size = new System.Drawing.Size(493, 468);
			...
			this.NzGrid.RecordsDeleted += new System.EventHandler(this.NzGrid_RecordsDeleted);
			...
			this.Name = "FormAqsatKind";
			this.Text = "تعریف نوع قسط بندی";
			this.Load += new System.EventHandler(this.FormAqsatKind_Load);
