...
{
    partial class FormAqsatMoedGozashte
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormAqsatMoedGozashte));
			Janus.Windows.Common.Layouts.JanusLayoutReference NzGridFuture_Layout_0_Reference_1 = new Janus.Windows.Common.Layouts.JanusLayoutReference("GridEXLayoutData.RootTable.Columns.Column13.ButtonImage");
			Janus.Windows.Common.Layouts.JanusLayoutReference NzGridFuture_Layout_0_Reference_2 = new Janus.Windows.Common.Layouts.JanusLayoutReference("GridEXLayoutData.RootTable.Columns.Column13.HeaderImage");
			...
			Janus.Windows.GridEX.GridEXLayout mS_GridX2_Layout_0 = new Janus.Windows.GridEX.GridEXLayout();
			Janus.Windows.Common.Layouts.JanusLayoutReference mS_GridX2_Layout_0_Reference_0 = new Janus.Windows.Common.Layouts.JanusLayoutReference("GridEXLayoutData.RootTable.Columns.Column0.ButtonImage");
			Janus.Windows.Common.Layouts.JanusLayoutReference mS_GridX2_Layout_0_Reference_1 = new Janus.Windows.Common.Layouts.JanusLayoutReference("GridEXLayoutData.RootTable.Columns.Column0.HeaderImage");
			...
			this.mS_GridX2 = new MS_Control.Controls.MS_GridX();
			...
			((System.ComponentModel.ISupportInitialize)(this.mS_GridX2)).BeginInit();
			...
			this.Tab_Control_Main.Size = new System.Drawing.Size(1343, 606);
			...
			this.uiTabPage12.Size = new System.Drawing.Size(1309, 604);
			...
			this.NzGridFuture.Size = new System.Drawing.Size(1309, 376);
			this.NzGridFuture.TabIndex = 9;
			...
			this.Splitter1.Size = new System.Drawing.Size(1309, 8);
			this.Splitter1.Style = DevComponents.DotNetBar.eSplitterStyle.Office2007;
			this.Splitter1.TabIndex = 755;
			...
			this.NzGridItems.Location = new System.Drawing.Point(0, 384);
			...
			this.NzGridItems.Size = new System.Drawing.Size(1309, 220);
			this.NzGridItems.TabIndex = 756;
			...
			this.uiTabPage14.Controls.Add(this.mS_GridX2);
			...
			this.uiTabPage14.Size = new System.Drawing.Size(1080, 431);
			this.uiTabPage14.TabStop = true;
			this.uiTabPage14.Text = "پرسش و پاسخ";
			// 
			// mS_GridX2
			// 
			this.mS_GridX2.AllowEdit = Janus.Windows.GridEX.InheritableBoolean.False;
			this.mS_GridX2.AllowRemoveColumns = Janus.Windows.GridEX.InheritableBoolean.True;
			this.mS_GridX2.AlternatingColors = true;
			this.mS_GridX2.AlternatingRowFormatStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
			this.mS_GridX2.BackColor = System.Drawing.Color.WhiteSmoke;
			this.mS_GridX2.BorderStyle = Janus.Windows.GridEX.BorderStyle.RaisedLight3D;
			this.mS_GridX2.ColumnSetNavigation = Janus.Windows.GridEX.ColumnSetNavigation.ColumnSet;
			this.mS_GridX2.Cursor = System.Windows.Forms.Cursors.Arrow;
			this.mS_GridX2.DefaultFilterRowComparison = Janus.Windows.GridEX.FilterConditionOperator.Contains;
			this.mS_GridX2.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mS_GridX2.DynamicFiltering = true;
			this.mS_GridX2.EnterKeyBehavior = Janus.Windows.GridEX.EnterKeyBehavior.None;
			this.mS_GridX2.FilterMode = Janus.Windows.GridEX.FilterMode.Automatic;
			this.mS_GridX2.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown;
			this.mS_GridX2.FilterRowFormatStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.mS_GridX2.FilterRowUpdateMode = Janus.Windows.GridEX.FilterRowUpdateMode.WhenValueChanges;
			this.mS_GridX2.FocusCellDisplayMode = Janus.Windows.GridEX.FocusCellDisplayMode.UseSelectedFormatStyle;
			this.mS_GridX2.FocusStyle = Janus.Windows.GridEX.FocusStyle.Solid;
			this.mS_GridX2.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.mS_GridX2.GridLineColor = System.Drawing.Color.Black;
			this.mS_GridX2.GridLines = Janus.Windows.GridEX.GridLines.Vertical;
			this.mS_GridX2.GridLineStyle = Janus.Windows.GridEX.GridLineStyle.Solid;
			this.mS_GridX2.GroupByBoxVisible = false;
			this.mS_GridX2.HeaderFormatStyle.BackColorGradient = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
			this.mS_GridX2.HeaderFormatStyle.ForeColor = System.Drawing.Color.Black;
			this.mS_GridX2.HideSelection = Janus.Windows.GridEX.HideSelection.HighlightInactive;
			mS_GridX2_Layout_0.IsCurrentLayout = true;
			mS_GridX2_Layout_0.Key = "Transfer";
			mS_GridX2_Layout_0_Reference_0.Instance = ((object)(resources.GetObject("mS_GridX2_Layout_0_Reference_0.Instance")));
			mS_GridX2_Layout_0_Reference_1.Instance = ((object)(resources.GetObject("mS_GridX2_Layout_0_Reference_1.Instance")));
			mS_GridX2_Layout_0.LayoutReferences.AddRange(new Janus.Windows.Common.Layouts.JanusLayoutReference[] {
            mS_GridX2_Layout_0_Reference_0,
            mS_GridX2_Layout_0_Reference_1});
			mS_GridX2_Layout_0.LayoutString = resources.GetString("mS_GridX2_Layout_0.LayoutString");
			this.mS_GridX2.Layouts.AddRange(new Janus.Windows.GridEX.GridEXLayout[] {
            mS_GridX2_Layout_0});
			this.mS_GridX2.Location = new System.Drawing.Point(0, 0);
			this.mS_GridX2.Name = "mS_GridX2";
			this.mS_GridX2.Office2007ColorScheme = Janus.Windows.GridEX.Office2007ColorScheme.Custom;
			this.mS_GridX2.Office2007CustomColor = System.Drawing.SystemColors.HotTrack;
			this.mS_GridX2.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.mS_GridX2.RowHeaderContent = Janus.Windows.GridEX.RowHeaderContent.RowIndex;
			this.mS_GridX2.SelectedFormatStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192)))));
			this.mS_GridX2.SelectedFormatStyle.ForeColor = System.Drawing.Color.Black;
			this.mS_GridX2.SelectedInactiveFormatStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192)))));
			this.mS_GridX2.SelectionMode = Janus.Windows.GridEX.SelectionMode.MultipleSelectionSameTable;
			this.mS_GridX2.SelectOnExpand = false;
			this.mS_GridX2.Size = new System.Drawing.Size(1080, 431);
			this.mS_GridX2.TabIndex = 9;
			this.mS_GridX2.TotalRow = Janus.Windows.GridEX.InheritableBoolean.True;
			this.mS_GridX2.TotalRowFormatStyle.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.mS_GridX2.TotalRowPosition = Janus.Windows.GridEX.TotalRowPosition.BottomFixed;
			this.mS_GridX2.TreeLineColor = System.Drawing.Color.Black;
			this.mS_GridX2.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.mS_GridX2.ColumnButtonClick += new Janus.Windows.GridEX.ColumnActionEventHandler(this.mS_GridX1_ColumnButtonClick);
			// 
			// mS_GridX_Setting1
			// 
            ...
            this.NsProgressText,
            this.NsCancel});
			this.mS_GridX_Setting1.Location = new System.Drawing.Point(0, 606);
			...
			this.mS_GridX_Setting1.Size = new System.Drawing.Size(1343, 25);
			this.mS_GridX_Setting1.TabIndex = 5;
			...
			this.Name = "FormAqsatMoedGozashte";
			this.Text = "گزارش کلیه اقساط موعد گذشته";
			...
			((System.ComponentModel.ISupportInitialize)(this.mS_GridX2)).EndInit();
        ...
        private MS_Control.Controls.MS_GridX mS_GridX2;
