namespace Nz.Asat.Winforms.Settings
{
	partial class TabSettingContainer
	{
		...
		private void InitializeComponent()
		{
			...
			this.NsUniqueSerial = new MS_Control.Controls.MS_CheckBox();
			...
			this.NsBarSetting.Controls.Add(this.NsUniqueSerial);
			...
			// NsUniqueSerial
			// 
			this.NsUniqueSerial.Anchor = System.Windows.Forms.AnchorStyles.Top;
			this.NsUniqueSerial.BackColor = System.Drawing.Color.Transparent;
			this.NsUniqueSerial.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NsUniqueSerial.Font = new System.Drawing.Font("IRANSans(Small) Medium", 13F);
			this.NsUniqueSerial.Location = new System.Drawing.Point(161, 110);
			this.NsUniqueSerial.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NsUniqueSerial.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.None;
			this.NsUniqueSerial.MS_Change_Border_Color_On_Enter = true;
			this.NsUniqueSerial.MS_Change_Color_On_Checked = true;
			this.NsUniqueSerial.MS_Change_Color_On_Enter = true;
			this.NsUniqueSerial.MS_Checked_Color = System.Drawing.Color.FromArgb(((int)(((byte)(128)))), ((int)(((byte)(255)))), ((int)(((byte)(128)))));
			this.NsUniqueSerial.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NsUniqueSerial.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NsUniqueSerial.MS_Exit_By_Down = true;
			this.NsUniqueSerial.MS_Exit_By_Enter = true;
			this.NsUniqueSerial.MS_Exit_By_Up = true;
			this.NsUniqueSerial.MS_Last_Control = null;
			this.NsUniqueSerial.MS_Next_Control = null;
			this.NsUniqueSerial.MS_UnChecked_Color = System.Drawing.Color.Transparent;
			this.NsUniqueSerial.Name = "NsUniqueSerial";
			this.NsUniqueSerial.ShowFocusRectangle = false;
			this.NsUniqueSerial.Size = new System.Drawing.Size(272, 26);
			this.NsUniqueSerial.TabIndex = 191;
			this.NsUniqueSerial.Text = "  ایجاد سریال یکتا بازای هر دسته بندی";
			this.NsUniqueSerial.VisualStyle = Janus.Windows.UI.VisualStyle.Office2003;
			// 
			// TabSettingContainer
			// 
		...
		private MS_Control.Controls.MS_CheckBox NsUniqueSerial;
	}
}
