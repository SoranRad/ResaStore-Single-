...
namespace Nz.Bar.Winforms.App
{
    partial class FormBar
    {
        ...
        private void InitializeComponent()
        {
			...
			this.NzRanande = new Nz.Bar.Winforms.Component.NzCarBox();
			this.label2 = new System.Windows.Forms.Label();
			this.NzCustomerKeshavarz = new NZ.General.WinForms.Component.NzRemainCustomer();
			...
			this.NzKeshavarz = new NZ.General.WinForms.Component.NzPeople();
			...
			this.NzMablaqKeraye = new MS_Control.Controls.MS_NumericTextBox();
			this.NzMablaq = new MS_Control.Controls.MS_NumericTextBox();
			this.NzVaznXales = new MS_Control.Controls.MS_NumericTextBox();
			this.NzFi = new MS_Control.Controls.MS_NumericTextBox();
			this.NzVaznOft = new MS_Control.Controls.MS_NumericTextBox();
			this.NzVazBoxXali = new MS_Control.Controls.MS_NumericTextBox();
			this.NzTedadBox = new MS_Control.Controls.MS_NumericTextBox();
			this.NzVaznKhaliMachine = new MS_Control.Controls.MS_NumericTextBox();
			this.NzVazPorMachin = new MS_Control.Controls.MS_NumericTextBox();
			...
			this.NzSumKhaliBox = new MS_Control.Controls.MS_NumericTextBox();
			this.label29 = new System.Windows.Forms.Label();
			this.label30 = new System.Windows.Forms.Label();
			this.NzDarsadOft = new MS_Control.Controls.MS_NumericTextBox();
			...
			this.Tab_Control_Main.Size = new System.Drawing.Size(666, 517);
			...
			this.uiTabPage12.Size = new System.Drawing.Size(632, 515);
			...
			this.uiGroupBox2.Controls.Add(this.NzRanande);
			this.uiGroupBox2.Controls.Add(this.label2);
			this.uiGroupBox2.Controls.Add(this.NzCustomerKeshavarz);
			this.uiGroupBox2.Controls.Add(this.NzDate);
			this.uiGroupBox2.Controls.Add(this.label8);
			this.uiGroupBox2.Controls.Add(this.NzSerial);
			this.uiGroupBox2.Controls.Add(this.label1);
			this.uiGroupBox2.Controls.Add(this.NzKeshavarz);
			...
			this.NzRanande.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzRanande.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzRanande.MS_CaptureFocus = false;
			this.NzRanande.MS_Change_Border_Color_On_Enter = true;
			this.NzRanande.MS_Change_Color_On_Enter = true;
			this.NzRanande.MS_Drop_Direction = MS_Control.TSDD.KindShow.Right;
			this.NzRanande.MS_DropDownSizeMode = MS_Control.TSDD.SizeMode.Control_Size;
			this.NzRanande.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzRanande.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzRanande.MS_Exit_By_Down = true;
			this.NzRanande.MS_Exit_By_Enter = true;
			this.NzRanande.MS_Exit_By_Up = true;
			this.NzRanande.MS_Last_Control = null;
			this.NzRanande.MS_Next_Control = null;
			...
			this.label2.Text = "راننده";
			// 
			// NzCustomerKeshavarz
			// 
			this.NzCustomerKeshavarz.Font = new System.Drawing.Font("IRANSans(Small)", 13F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.NzCustomerKeshavarz.Location = new System.Drawing.Point(8, 57);
			this.NzCustomerKeshavarz.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzCustomerKeshavarz.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzCustomerKeshavarz.MS_Color_End = System.Drawing.Color.Empty;
			this.NzCustomerKeshavarz.MS_Color_Start = System.Drawing.Color.Empty;
			this.NzCustomerKeshavarz.Name = "NzCustomerKeshavarz";
			this.NzCustomerKeshavarz.Size = new System.Drawing.Size(126, 29);
			this.NzCustomerKeshavarz.TabIndex = 766;
			this.NzCustomerKeshavarz.Text = "0";
			this.NzCustomerKeshavarz.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// NzDate
			// 
			...
			this.NzKeshavarz.MS_Auto_Popup = false;
			this.NzKeshavarz.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzKeshavarz.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzKeshavarz.MS_CaptureFocus = false;
			this.NzKeshavarz.MS_Change_Border_Color_On_Enter = true;
			this.NzKeshavarz.MS_Change_Color_On_Enter = true;
			this.NzKeshavarz.MS_Drop_Direction = MS_Control.TSDD.KindShow.Right;
			this.NzKeshavarz.MS_DropDownSizeMode = MS_Control.TSDD.SizeMode.Control_Size;
			this.NzKeshavarz.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzKeshavarz.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzKeshavarz.MS_Exit_By_Down = true;
			this.NzKeshavarz.MS_Exit_By_Enter = true;
			this.NzKeshavarz.MS_Exit_By_Up = true;
			this.NzKeshavarz.MS_Last_Control = null;
			this.NzKeshavarz.MS_Next_Control = null;
			...
			this.NzKeshavarz.MS_On_Row_Selected += new System.EventHandler<MS_Control.TSDD.On_Selected>(this.NzKeshavarz_MS_On_Row_Selected);
			// 
			// NzCustomerLable
			// 
			...
			this.NzCustomerLable.Text = "کشـاورز";
			// 
			// uiGroupBox1
			// 
			...
			this.uiGroupBox1.Controls.Add(this.NzSumKhaliBox);
			...
			this.uiGroupBox1.Controls.Add(this.NzObjectSelection);
			this.uiGroupBox1.Controls.Add(this.label4);
			this.uiGroupBox1.Controls.Add(this.NzMablaqKeraye);
			this.uiGroupBox1.Controls.Add(this.NzMablaq);
			this.uiGroupBox1.Controls.Add(this.NzVaznXales);
			this.uiGroupBox1.Controls.Add(this.NzFi);
			this.uiGroupBox1.Controls.Add(this.NzVaznOft);
			this.uiGroupBox1.Controls.Add(this.NzDarsadOft);
			this.uiGroupBox1.Controls.Add(this.NzVazBoxXali);
			this.uiGroupBox1.Controls.Add(this.NzTedadBox);
			this.uiGroupBox1.Controls.Add(this.NzVaznKhaliMachine);
			this.uiGroupBox1.Controls.Add(this.NzVazPorMachin);
			...
			this.uiGroupBox1.Size = new System.Drawing.Size(618, 403);
			...
			this.label28.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label28.ForeColor = System.Drawing.Color.Maroon;
			this.label28.Location = new System.Drawing.Point(31, 151);
			this.label28.Name = "label28";
			this.label28.Size = new System.Drawing.Size(48, 23);
			this.label28.TabIndex = 761;
			this.label28.Text = "کیلوگرم";
			// 
			// label27
			// 
			this.label27.AutoSize = true;
			this.label27.BackColor = System.Drawing.Color.Transparent;
			this.label27.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label27.ForeColor = System.Drawing.Color.Maroon;
			this.label27.Location = new System.Drawing.Point(31, 101);
			this.label27.Name = "label27";
			this.label27.Size = new System.Drawing.Size(48, 23);
			this.label27.TabIndex = 761;
			this.label27.Text = "کیلوگرم";
			// 
			// label26
			// 
			this.label26.AutoSize = true;
			this.label26.BackColor = System.Drawing.Color.Transparent;
			this.label26.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label26.ForeColor = System.Drawing.Color.Maroon;
			this.label26.Location = new System.Drawing.Point(322, 237);
			this.label26.Name = "label26";
			this.label26.Size = new System.Drawing.Size(48, 23);
			this.label26.TabIndex = 761;
			this.label26.Text = "کیلوگرم";
			// 
			// label25
			// 
			this.label25.AutoSize = true;
			this.label25.BackColor = System.Drawing.Color.Transparent;
			this.label25.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label25.ForeColor = System.Drawing.Color.Maroon;
			this.label25.Location = new System.Drawing.Point(322, 155);
			this.label25.Name = "label25";
			this.label25.Size = new System.Drawing.Size(48, 23);
			this.label25.TabIndex = 761;
			this.label25.Text = "کیلوگرم";
			// 
			// label24
			// 
			this.label24.AutoSize = true;
			this.label24.BackColor = System.Drawing.Color.Transparent;
			this.label24.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label24.ForeColor = System.Drawing.Color.Maroon;
			this.label24.Location = new System.Drawing.Point(322, 101);
			this.label24.Name = "label24";
			this.label24.Size = new System.Drawing.Size(48, 23);
			this.label24.TabIndex = 761;
			this.label24.Text = "کیلوگرم";
			// 
			// label23
			// 
			this.label23.AutoSize = true;
			this.label23.BackColor = System.Drawing.Color.Transparent;
			this.label23.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label23.ForeColor = System.Drawing.Color.Maroon;
			this.label23.Location = new System.Drawing.Point(322, 64);
			this.label23.Name = "label23";
			this.label23.Size = new System.Drawing.Size(48, 23);
			this.label23.TabIndex = 761;
			this.label23.Text = "کیلوگرم";
			// 
			// label22
			// 
			...
			this.label22.Location = new System.Drawing.Point(505, 357);
			this.label22.Name = "label22";
			this.label22.Size = new System.Drawing.Size(71, 23);
			this.label22.TabIndex = 760;
			this.label22.Text = "توضـیـحات";
			// 
			// NzDescription
			// 
			...
			this.NzDescription.Location = new System.Drawing.Point(6, 353);
			...
			this.label4.Text = "انتخـاب محصول";
			// 
			// NzMablaqKeraye
			// 
			this.NzMablaqKeraye.ButtonText = "000";
			this.NzMablaqKeraye.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NzMablaqKeraye.Font = new System.Drawing.Font("IRANSans(Small)", 15F);
			this.NzMablaqKeraye.Location = new System.Drawing.Point(82, 275);
			this.NzMablaqKeraye.MaxLength = 0;
			this.NzMablaqKeraye.Mode = MS_Control.Controls.MS_NumericTextBox.TextBoxMode.IntNumber;
			this.NzMablaqKeraye.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzMablaqKeraye.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzMablaqKeraye.MS_Change_Border_Color_On_Enter = true;
			this.NzMablaqKeraye.MS_Change_Color_On_Enter = true;
			this.NzMablaqKeraye.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzMablaqKeraye.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzMablaqKeraye.MS_Exit_By_Down = true;
			this.NzMablaqKeraye.MS_Exit_By_Enter = true;
			this.NzMablaqKeraye.MS_Exit_By_Up = true;
			this.NzMablaqKeraye.MS_Is_Negative = false;
			this.NzMablaqKeraye.MS_Last_Control = null;
			this.NzMablaqKeraye.MS_Next_Control = null;
			this.NzMablaqKeraye.Name = "NzMablaqKeraye";
			this.NzMablaqKeraye.Size = new System.Drawing.Size(128, 32);
			this.NzMablaqKeraye.TabIndex = 8;
			this.NzMablaqKeraye.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzMablaqKeraye.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			// 
			// NzMablaq
			// 
			this.NzMablaq.BackColor = System.Drawing.Color.Gainsboro;
			...
			this.NzMablaq.Location = new System.Drawing.Point(82, 222);
			...
			this.NzMablaq.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzMablaq.MS_Change_Border_Color_On_Enter = true;
			this.NzMablaq.MS_Change_Color_On_Enter = true;
			this.NzMablaq.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzMablaq.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzMablaq.MS_Exit_By_Down = true;
			this.NzMablaq.MS_Exit_By_Enter = true;
			this.NzMablaq.MS_Exit_By_Up = true;
			this.NzMablaq.MS_Is_Negative = false;
			this.NzMablaq.MS_Last_Control = null;
			this.NzMablaq.MS_Next_Control = null;
			this.NzMablaq.Name = "NzMablaq";
			this.NzMablaq.ReadOnly = true;
			this.NzMablaq.Size = new System.Drawing.Size(128, 32);
			this.NzMablaq.TabIndex = 165;
			this.NzMablaq.TabStop = false;
			this.NzMablaq.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzMablaq.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			// 
			// NzVaznXales
			// 
			this.NzVaznXales.BackColor = System.Drawing.Color.Gainsboro;
			...
			this.NzVaznXales.Location = new System.Drawing.Point(82, 146);
			...
			this.NzVaznXales.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzVaznXales.MS_Change_Border_Color_On_Enter = true;
			this.NzVaznXales.MS_Change_Color_On_Enter = true;
			this.NzVaznXales.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzVaznXales.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzVaznXales.MS_Exit_By_Down = true;
			this.NzVaznXales.MS_Exit_By_Enter = true;
			this.NzVaznXales.MS_Exit_By_Up = true;
			this.NzVaznXales.MS_Is_Negative = false;
			this.NzVaznXales.MS_Last_Control = null;
			this.NzVaznXales.MS_Next_Control = null;
			this.NzVaznXales.Name = "NzVaznXales";
			this.NzVaznXales.ReadOnly = true;
			this.NzVaznXales.Size = new System.Drawing.Size(128, 32);
			this.NzVaznXales.TabIndex = 165;
			this.NzVaznXales.TabStop = false;
			this.NzVaznXales.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzVaznXales.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			// 
			// NzFi
			// 
			this.NzFi.ButtonText = "000";
			this.NzFi.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NzFi.Font = new System.Drawing.Font("IRANSans(Small)", 15F);
			this.NzFi.Location = new System.Drawing.Point(82, 184);
			this.NzFi.MaxLength = 0;
			this.NzFi.Mode = MS_Control.Controls.MS_NumericTextBox.TextBoxMode.IntNumber;
			this.NzFi.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzFi.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzFi.MS_Change_Border_Color_On_Enter = true;
			this.NzFi.MS_Change_Color_On_Enter = true;
			this.NzFi.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzFi.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzFi.MS_Exit_By_Down = true;
			this.NzFi.MS_Exit_By_Enter = true;
			this.NzFi.MS_Exit_By_Up = true;
			this.NzFi.MS_Is_Negative = false;
			this.NzFi.MS_Last_Control = null;
			this.NzFi.MS_Next_Control = null;
			this.NzFi.Name = "NzFi";
			this.NzFi.Size = new System.Drawing.Size(128, 32);
			this.NzFi.TabIndex = 7;
			this.NzFi.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzFi.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzFi.TextChanged += new System.EventHandler(this.NzFi_TextChanged);
			// 
			// NzVaznOft
			// 
			this.NzVaznOft.ButtonText = "000";
			this.NzVaznOft.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NzVaznOft.Font = new System.Drawing.Font("IRANSans(Small)", 15F);
			this.NzVaznOft.Location = new System.Drawing.Point(82, 96);
			this.NzVaznOft.MaxLength = 0;
			this.NzVaznOft.Mode = MS_Control.Controls.MS_NumericTextBox.TextBoxMode.IntNumber;
			this.NzVaznOft.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzVaznOft.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzVaznOft.MS_Change_Border_Color_On_Enter = true;
			this.NzVaznOft.MS_Change_Color_On_Enter = true;
			this.NzVaznOft.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzVaznOft.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzVaznOft.MS_Exit_By_Down = true;
			this.NzVaznOft.MS_Exit_By_Enter = true;
			this.NzVaznOft.MS_Exit_By_Up = true;
			this.NzVaznOft.MS_Is_Negative = false;
			this.NzVaznOft.MS_Last_Control = null;
			this.NzVaznOft.MS_Next_Control = null;
			this.NzVaznOft.Name = "NzVaznOft";
			this.NzVaznOft.Size = new System.Drawing.Size(128, 32);
			this.NzVaznOft.TabIndex = 6;
			this.NzVaznOft.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzVaznOft.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzVaznOft.TextChanged += new System.EventHandler(this.Vazn_TextChanged);
			// 
			// NzVazBoxXali
			// 
			this.NzVazBoxXali.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.NzVazBoxXali.Location = new System.Drawing.Point(371, 190);
			this.NzVazBoxXali.MaxLength = 0;
			this.NzVazBoxXali.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzVazBoxXali.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzVazBoxXali.MS_Change_Border_Color_On_Enter = true;
			this.NzVazBoxXali.MS_Change_Color_On_Enter = true;
			this.NzVazBoxXali.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzVazBoxXali.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzVazBoxXali.MS_Exit_By_Down = true;
			this.NzVazBoxXali.MS_Exit_By_Enter = true;
			this.NzVazBoxXali.MS_Exit_By_Up = true;
			this.NzVazBoxXali.MS_Is_Negative = false;
			this.NzVazBoxXali.MS_Last_Control = null;
			this.NzVazBoxXali.MS_Next_Control = null;
			this.NzVazBoxXali.Name = "NzVazBoxXali";
			this.NzVazBoxXali.Size = new System.Drawing.Size(128, 32);
			this.NzVazBoxXali.TabIndex = 4;
			this.NzVazBoxXali.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzVazBoxXali.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzVazBoxXali.TextChanged += new System.EventHandler(this.Vazn_TextChanged);
			// 
			// NzTedadBox
			// 
			this.NzTedadBox.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.NzTedadBox.Location = new System.Drawing.Point(399, 150);
			...
			this.NzTedadBox.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzTedadBox.MS_Change_Border_Color_On_Enter = true;
			this.NzTedadBox.MS_Change_Color_On_Enter = true;
			this.NzTedadBox.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzTedadBox.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzTedadBox.MS_Exit_By_Down = true;
			this.NzTedadBox.MS_Exit_By_Enter = true;
			this.NzTedadBox.MS_Exit_By_Up = true;
			this.NzTedadBox.MS_Is_Negative = false;
			this.NzTedadBox.MS_Last_Control = null;
			this.NzTedadBox.MS_Next_Control = null;
			this.NzTedadBox.Name = "NzTedadBox";
			this.NzTedadBox.Size = new System.Drawing.Size(100, 32);
			this.NzTedadBox.TabIndex = 3;
			this.NzTedadBox.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzTedadBox.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzTedadBox.TextChanged += new System.EventHandler(this.Vazn_TextChanged);
			// 
			// NzVaznKhaliMachine
			// 
			this.NzVaznKhaliMachine.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.NzVaznKhaliMachine.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzVaznKhaliMachine.MS_Change_Border_Color_On_Enter = true;
			this.NzVaznKhaliMachine.MS_Change_Color_On_Enter = true;
			this.NzVaznKhaliMachine.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzVaznKhaliMachine.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzVaznKhaliMachine.MS_Exit_By_Down = true;
			this.NzVaznKhaliMachine.MS_Exit_By_Enter = true;
			this.NzVaznKhaliMachine.MS_Exit_By_Up = true;
			this.NzVaznKhaliMachine.MS_Is_Negative = false;
			this.NzVaznKhaliMachine.MS_Last_Control = null;
			this.NzVaznKhaliMachine.MS_Next_Control = null;
			this.NzVaznKhaliMachine.Name = "NzVaznKhaliMachine";
			this.NzVaznKhaliMachine.Size = new System.Drawing.Size(128, 32);
			this.NzVaznKhaliMachine.TabIndex = 2;
			this.NzVaznKhaliMachine.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzVaznKhaliMachine.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzVaznKhaliMachine.TextChanged += new System.EventHandler(this.Vazn_TextChanged);
			// 
			// NzVazPorMachin
			// 
			this.NzVazPorMachin.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.NzVazPorMachin.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzVazPorMachin.MS_Change_Border_Color_On_Enter = true;
			this.NzVazPorMachin.MS_Change_Color_On_Enter = true;
			this.NzVazPorMachin.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzVazPorMachin.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzVazPorMachin.MS_Exit_By_Down = true;
			this.NzVazPorMachin.MS_Exit_By_Enter = true;
			this.NzVazPorMachin.MS_Exit_By_Up = true;
			this.NzVazPorMachin.MS_Is_Negative = false;
			this.NzVazPorMachin.MS_Last_Control = null;
			this.NzVazPorMachin.MS_Next_Control = null;
			this.NzVazPorMachin.Name = "NzVazPorMachin";
			this.NzVazPorMachin.Size = new System.Drawing.Size(128, 32);
			this.NzVazPorMachin.TabIndex = 1;
			this.NzVazPorMachin.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzVazPorMachin.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzVazPorMachin.TextChanged += new System.EventHandler(this.Vazn_TextChanged);
			// 
			// label21
			// 
			this.label21.AutoSize = true;
			this.label21.BackColor = System.Drawing.Color.Transparent;
			this.label21.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label21.ForeColor = System.Drawing.Color.Green;
			this.label21.Location = new System.Drawing.Point(81, 307);
			this.label21.Name = "label21";
			this.label21.Size = new System.Drawing.Size(181, 23);
			this.label21.TabIndex = 164;
			this.label21.Text = "برای محاسبه صورتـحسـاب راننده";
			// 
			// label20
			// 
			...
			this.label20.Location = new System.Drawing.Point(216, 280);
			...
			this.label17.Location = new System.Drawing.Point(217, 151);
			this.label17.Name = "label17";
			this.label17.Size = new System.Drawing.Size(71, 23);
			this.label17.TabIndex = 163;
			this.label17.Text = "وزن خـالص";
			// 
			// label16
			// 
			...
			this.label16.Location = new System.Drawing.Point(217, 101);
			this.label16.Name = "label16";
			this.label16.Size = new System.Drawing.Size(76, 23);
			this.label16.TabIndex = 163;
			this.label16.Text = "افت محصول";
			// 
			// label15
			// 
			...
			this.label15.Location = new System.Drawing.Point(505, 195);
			this.label15.Name = "label15";
			this.label15.Size = new System.Drawing.Size(93, 23);
			this.label15.TabIndex = 163;
			this.label15.Text = "وزن جعـبه خالی";
			// 
			// label14
			// 
			...
			this.label14.Text = "تعداد جعـبه خالی";
			// 
			// label6
			// 
			...
			this.label6.Text = "وزن خـالی ماشین";
			// 
			// label5
			// 
			...
			this.label5.Text = "وزن پـر مـاشین";
			// 
			// uiTabPage14
			// 
			this.uiTabPage14.AutoScroll = true;
			this.uiTabPage14.Controls.Add(this.label10);
			this.uiTabPage14.Controls.Add(this.label9);
			this.uiTabPage14.Controls.Add(this.label13);
			this.uiTabPage14.Controls.Add(this.label12);
			this.uiTabPage14.Controls.Add(this.label11);
			this.uiTabPage14.Controls.Add(this.label7);
			this.uiTabPage14.Controls.Add(this.label3);
			...
			this.uiTabPage14.Size = new System.Drawing.Size(632, 455);
			...
			this.label13.Location = new System.Drawing.Point(521, 127);
			...
			this.label12.Location = new System.Drawing.Point(521, 93);
			...
			this.label11.Location = new System.Drawing.Point(521, 57);
			...
			this.label7.Location = new System.Drawing.Point(417, 57);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.Panel_Foother.Controls.Add(this.NzPrint);
			this.Panel_Foother.Controls.Add(this.NzNew);
			this.Panel_Foother.Controls.Add(this.ms_Save);
			this.Panel_Foother.Location = new System.Drawing.Point(0, 515);
			...
			this.NzPrint.Office2007CustomColor = System.Drawing.Color.Teal;
			this.NzPrint.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.NzPrint.ShowFocusRectangle = false;
			this.NzPrint.Size = new System.Drawing.Size(129, 32);
			this.NzPrint.TabIndex = 2;
			...
			// NzNew
			// 
			this.NzNew.Anchor = System.Windows.Forms.AnchorStyles.Top;
			...
			this.NzNew.Office2007CustomColor = System.Drawing.Color.Green;
			...
			this.ms_Save.Location = new System.Drawing.Point(7, 11);
			...
			this.ms_Save.Size = new System.Drawing.Size(129, 32);
			...
			// NzSumKhaliBox
			// 
			this.NzSumKhaliBox.BackColor = System.Drawing.Color.Gainsboro;
			this.NzSumKhaliBox.ButtonText = "000";
			this.NzSumKhaliBox.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NzSumKhaliBox.Font = new System.Drawing.Font("IRANSans(Small)", 15F);
			this.NzSumKhaliBox.Location = new System.Drawing.Point(371, 232);
			this.NzSumKhaliBox.MaxLength = 0;
			this.NzSumKhaliBox.Mode = MS_Control.Controls.MS_NumericTextBox.TextBoxMode.IntNumber;
			this.NzSumKhaliBox.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzSumKhaliBox.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzSumKhaliBox.MS_Change_Border_Color_On_Enter = true;
			this.NzSumKhaliBox.MS_Change_Color_On_Enter = true;
			this.NzSumKhaliBox.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzSumKhaliBox.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzSumKhaliBox.MS_Exit_By_Down = true;
			this.NzSumKhaliBox.MS_Exit_By_Enter = true;
			this.NzSumKhaliBox.MS_Exit_By_Up = true;
			this.NzSumKhaliBox.MS_Is_Negative = false;
			this.NzSumKhaliBox.MS_Last_Control = null;
			this.NzSumKhaliBox.MS_Next_Control = null;
			this.NzSumKhaliBox.Name = "NzSumKhaliBox";
			this.NzSumKhaliBox.ReadOnly = true;
			this.NzSumKhaliBox.Size = new System.Drawing.Size(128, 32);
			this.NzSumKhaliBox.TabIndex = 762;
			this.NzSumKhaliBox.TabStop = false;
			this.NzSumKhaliBox.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzSumKhaliBox.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			// 
			// label29
			// 
			...
			this.label29.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label29.ForeColor = System.Drawing.Color.Green;
			this.label29.Location = new System.Drawing.Point(505, 225);
			this.label29.Name = "label29";
			this.label29.Size = new System.Drawing.Size(73, 46);
			this.label29.TabIndex = 163;
			this.label29.Text = "مجموع وزن\r\n جعـبه خالی";
			// 
			// label30
			// 
			this.label30.AutoSize = true;
			this.label30.BackColor = System.Drawing.Color.Transparent;
			this.label30.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label30.ForeColor = System.Drawing.Color.Maroon;
			this.label30.Location = new System.Drawing.Point(322, 195);
			this.label30.Name = "label30";
			this.label30.Size = new System.Drawing.Size(48, 23);
			this.label30.TabIndex = 761;
			this.label30.Text = "کیلوگرم";
			// 
			// NzDarsadOft
			// 
			this.NzDarsadOft.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.NzDarsadOft.ButtonText = "000";
			this.NzDarsadOft.Cursor = System.Windows.Forms.Cursors.Hand;
			this.NzDarsadOft.Font = new System.Drawing.Font("IRANSans(Small)", 15F);
			this.NzDarsadOft.Location = new System.Drawing.Point(108, 59);
			this.NzDarsadOft.MaxLength = 0;
			this.NzDarsadOft.MS_BorderColor = System.Drawing.Color.SteelBlue;
			this.NzDarsadOft.MS_BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.NzDarsadOft.MS_Change_Border_Color_On_Enter = true;
			this.NzDarsadOft.MS_Change_Color_On_Enter = true;
			this.NzDarsadOft.MS_Enter_Border_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.NzDarsadOft.MS_Enter_Color = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(192)))));
			this.NzDarsadOft.MS_Exit_By_Down = true;
			this.NzDarsadOft.MS_Exit_By_Enter = true;
			this.NzDarsadOft.MS_Exit_By_Up = true;
			this.NzDarsadOft.MS_Is_Negative = false;
			this.NzDarsadOft.MS_Last_Control = null;
			this.NzDarsadOft.MS_Next_Control = null;
			this.NzDarsadOft.Name = "NzDarsadOft";
			this.NzDarsadOft.Size = new System.Drawing.Size(102, 32);
			this.NzDarsadOft.TabIndex = 5;
			this.NzDarsadOft.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center;
			this.NzDarsadOft.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007;
			this.NzDarsadOft.TextChanged += new System.EventHandler(this.NzDarsadOft_TextChanged);
			// 
			// label31
			// 
			this.label31.AutoSize = true;
			this.label31.BackColor = System.Drawing.Color.Transparent;
			this.label31.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label31.ForeColor = System.Drawing.Color.Maroon;
			this.label31.Location = new System.Drawing.Point(31, 64);
			this.label31.Name = "label31";
			this.label31.Size = new System.Drawing.Size(48, 23);
			this.label31.TabIndex = 761;
			this.label31.Text = "کیلوگرم";
			// 
			// label32
			// 
			this.label32.AutoSize = true;
			this.label32.BackColor = System.Drawing.Color.Transparent;
			this.label32.Font = new System.Drawing.Font("IRANSans(Small)", 13F);
			this.label32.Location = new System.Drawing.Point(216, 64);
			this.label32.Name = "label32";
			this.label32.Size = new System.Drawing.Size(63, 23);
			this.label32.TabIndex = 163;
			this.label32.Text = "درصد افت";
			// 
			// FormBar
			// 
			...
			this.uiTabPage14.PerformLayout();
		...
		private NZ.General.WinForms.Component.NzRemainCustomer NzCustomerKeshavarz;
		private MS_Control.Tarikh.MS_Tarikh_TextBox NzDate;
		private System.Windows.Forms.Label label8;
		private MS_Control.Controls.MS_NumericTextBox NzSerial;
		private System.Windows.Forms.Label label1;
		private NZ.General.WinForms.Component.NzPeople NzKeshavarz;
		...
		private MS_Control.Controls.MS_NumericTextBox NzMablaq;
		private MS_Control.Controls.MS_NumericTextBox NzVaznXales;
		private MS_Control.Controls.MS_NumericTextBox NzFi;
		private MS_Control.Controls.MS_NumericTextBox NzVaznOft;
		private MS_Control.Controls.MS_NumericTextBox NzVazBoxXali;
		private MS_Control.Controls.MS_NumericTextBox NzTedadBox;
		private MS_Control.Controls.MS_NumericTextBox NzVaznKhaliMachine;
		private MS_Control.Controls.MS_NumericTextBox NzVazPorMachin;
		private MS_Control.Controls.MS_NumericTextBox NzMablaqKeraye;
		private Component.NzCarBox NzRanande;
		...
		private MS_Control.Controls.MS_NumericTextBox NzSumKhaliBox;
		private System.Windows.Forms.Label label30;
		private System.Windows.Forms.Label label29;
		private System.Windows.Forms.Label label31;
		private MS_Control.Controls.MS_NumericTextBox NzDarsadOft;
